...
const AddStartupstage = ({ show, handleClose, fetchStartupStageData }) => {
    ...
    return (
        <Modal centered show={show} onHide={handleClose} className="form-modal">
            <div className="modal-header" closeButton>
                <h5 className="modal-title" id="deleteModalLabel">Add Startup Stage</h5>
...
export default AddStartupstage;