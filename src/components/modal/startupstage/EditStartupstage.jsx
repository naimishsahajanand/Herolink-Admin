...
const EditStartupstage = ({ show, handleClose, editData, fetchStartupStageData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await axiosInstance.put(`/admin/startup-stage/edit/${formData?.id}`, payload, authHeader());
    ...
    return (
        <Modal centered show={show} onHide={handleClose} className="form-modal">
            <div className="modal-header" closeButton>
                <h5 className="modal-title" id="deleteModalLabel">Edit Startup Stage</h5>
...
export default EditStartupstage;