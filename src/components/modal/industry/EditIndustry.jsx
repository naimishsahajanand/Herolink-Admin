...
const EditIndustry = ({ show, handleClose, editData, fetchIndustryData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await axiosInstance.put(`/admin/industry/edit/${formData?.id}`, payload, authHeader());
    ...
    return (
        <Modal centered show={show} onHide={handleClose} className="form-modal">
            <div className="modal-header" closeButton>
                <h5 className="modal-title" id="deleteModalLabel">Edit Industry</h5>
