...
const EditBusinessRightNow = ({ show, handleClose, editData, fetchBusinessRightNowData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (data?.data?.status === true) {
                toast.success("Your Business Right Now edited successfully!");
    ...
    return (
        <Modal centered show={show} onHide={handleClose} className="form-modal">
            <div className="modal-header" closeButton>
                <h5 className="modal-title" id="deleteModalLabel">Edit Your Business Right Now</h5>
...
export default EditBusinessRightNow