...
const AddBusinessRightNow = ({ show, handleClose, fetchBusinessRightNowData }) => {
    ...
    return (
        <Modal centered show={show} onHide={handleClose} className="form-modal">
            <div className="modal-header" closeButton>
                <h5 className="modal-title" id="deleteModalLabel">Add Your Business Right Now</h5>
...
export default AddBusinessRightNow