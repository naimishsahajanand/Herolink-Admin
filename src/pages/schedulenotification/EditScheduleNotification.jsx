...
const AddScheduleNotification = () => {
    ...
    const editData = JSON.parse(localStorage.getItem("edit-notification"));
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            endDate: formData?.type === "Singleday" ? currentDate : formData?.endDate,
            time: formData?.time,
        ...
        try {
            const data = await axiosInstance.put(`/admin/schedule-notification/edit/${editData?.id}`, payload, authImageHeader());
                    ...
                    <div class="content-new">
                        <div class="row">
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                <h2 class="mb-0">Edit Notification</h2>
                            </div>
