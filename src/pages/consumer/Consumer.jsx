...
const Consumer = () => {
    ...
    const handleDelete = async () => {
        try {
            ...
            const data = await axiosInstance.delete(`/admin/consumer-segment/delete/${deleteId}`, authHeader());
            if (data?.status === 200) {
    ...
    return (
        <>
            ...
            {/* ======= Data Add Offcanvas ======== */}
            <AddConsumer show={addShow} fetchConsumerData={fetchConsumerData} handleClose={handleClose} />
            <EditConsumer show={editShow} fetchConsumerData={fetchConsumerData} handleClose={handleClose} editData={editData} />
